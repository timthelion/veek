...
module Morphology.AdjectivesIntro where
import Nav
...
<img src="../images/intenserap.png" alt="Two rappers rapping and a partridge in a pear tree." width="90%"/>
  ...
  "Hey, you was a complete(**A**mplifier a**D**jective) mess.  I was afraid I'd get AIDs if I came too close." 
...
#### semantic classification of adjectives
  ...
  **In**herent/noninherent

  **G**radable/non-gradeable

<img src="../images/sing.png" width="90%" alt="A man singing to a woman." />
