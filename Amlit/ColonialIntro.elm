...
module Amlit.ColonialIntro where
import Nav
...
[Cotton Mather](http://en.wikipedia.org/wiki/Cotton_Mather)

 - The Negro Christianized (1706)

[John Winthrop](http://en.wikipedia.org/wiki/John_Winthrop)

 - A Modell of Christian Charity(A shining city on a hill)(1630)

[William Bradford](http://en.wikipedia.org/wiki/William_Bradford_%28Plymouth_Colony_governor%29)

 - Of Plymouth Plantation(1630-1651)

### Other authors

[Captain John Smith](http://en.wikipedia.org/wiki/Captain_John_Smith)

 - The Generall Historie of Virginia(1624)
