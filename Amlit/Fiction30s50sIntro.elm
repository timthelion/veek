...
module Amlit.Fiction30s50sIntro where
import Nav
main = flow down [Nav.nav,
 [markdown|

## American Fiction 1930s - 1950s

[John Steinback](http://en.wikipedia.org/wiki/John_Steinback)

 - Grapes of Wrath(1939)
 - Of Mice and Men(1937)

[Jerome David Salinger](http://en.wikipedia.org/wiki/Jerome_David_Salinger)

 - The Catcher in the Rye(1951)

### The Beatniks

[Jack Kérouac](http://en.wikipedia.org/wiki/Jack_Kerouac)
