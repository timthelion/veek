...
module Amlit.Poetry20thIntro where
import Nav
...
[T.S. Eliot](http://en.wikipedia.org/wiki/T.S._Eliot)
...
[e.e. cummings](http://en.wikipedia.org/wiki/E.e._cummings)

 - Tulips and Chimneys(1923)

[Play level](Poetry20th.html)
