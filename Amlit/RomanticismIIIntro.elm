...
module Amlit.RomanticismIIIntro where
import Nav
main = flow down [Nav.nav,
 [markdown|

## Romanticism II: Trancendentalism
...
[Ralph Waldo Emerson](http://en.wikipedia.org/wiki/Ralph_Waldo_Emerson)
 ...
 - Edited the trancendentalist magazine "The Dial" from 1840 onwards.
 - Self-Reliance(1841)
